...
export class QuizService {
 ...
 constructor(private http: HttpClient) { }
  ...
  // Get all questions
  getQuizQuestions(noOfQuestions,userName,technologyStream,complexityLevel,account) {
  let url = `${this.baseUri}/${noOfQuestions}/${userName}/${technologyStream}/${complexityLevel}/${account}`;
    console.log('url----'+url);
